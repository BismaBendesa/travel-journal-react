...
export default function(props){
  function scaleMouseEnter(e){
    if (e.target.classList.contains("img")){
      e.target.classList.toggle('scale-hover')
    }
  }
  function shrinkMouseLeave(e){
    if (e.target.classList.contains("img")){
      e.target.classList.toggle('scale-hover')
    }
  }
  return(
    <div className="travel-card" onMouseEnter={scaleMouseEnter} onMouseLeave={shrinkMouseLeave}>
      ...
      <div className="travel-details">
        <div className="location-wrapper">
          ...
          <a target="_blank" href={props.locationLink} className="map-link">View on Google Maps</a>
        </div>
